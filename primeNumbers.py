...
print("Bad approach takes ", round(timeit.timeit('list_primes_bad(10000)', globals=globals(), number=1), 4), " seconds.")

# Approach 2: Naive approach 
print("Naive approach takes ", round(timeit.timeit('list_primes_naive(10000)', globals=globals(), number=1), 4), " seconds.")

# Approach 3: Sieve algorithm 
print ("Sieve algorithm takes ", round(timeit.timeit('list_primes_up_to(10000)', globals=globals(), number=1), 4), " seconds.")
